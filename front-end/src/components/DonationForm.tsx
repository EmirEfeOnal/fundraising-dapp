...
export default function DonationForm() {
  ...
  const handleDonate = async () => {
    ...
    try {
      // Simulate donation process (replace with actual Stacks integration)
  ...
  return (
    <div className="py-16 bg-gradient-to-br from-forest-light/5 to-ocean-light/5">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full p-4 border-2 rounded-xl font-semibold text-lg transition-colors ${
                      isCustom
                        ? "border-forest-primary focus:border-forest-secondary"
              ...
              <button
                ...
                className={`w-full py-4 px-6 rounded-2xl font-bold text-lg transition-all transform ${
                  currentAmount > 0 && !isLoading
                    ? "bg-gradient-to-r from-forest-primary to-ocean-primary hover:from-forest-secondary hover:to-ocean-secondary text-white hover:scale-105 shadow-lg"
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-3xl shadow-2xl p-8 border">
                <div className="flex items-center gap-3 mb-6">
                  <Calculator className="w-6 h-6 text-forest-primary" />
                  <h3 className="text-2xl font-bold text-gray-900">Your Environmental Impact</h3>
                </div>

                {currentAmount > 0 ? (
                  <div className="space-y-4">
                    <div className="bg-gradient-to-r from-forest-primary to-forest-secondary rounded-2xl p-4 text-white">
                    ...
                    <div className="bg-gradient-to-r from-ocean-primary to-ocean-secondary rounded-2xl p-4 text-white">
                      <div className="flex items-center gap-3 mb-2">
                        <Waves className="w-6 h-6" />
                        <span className="font-semibold">Ocean Plastic Removed</span>
                      </div>
                      <div className="text-3xl font-bold">{impact.plastic}kg</div>
                      <p className="text-ocean-light text-sm">From oceans and waterways</p>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-green-50 rounded-xl p-4 text-center">
                        <div className="text-2xl font-bold text-green-600">{impact.co2}</div>
                        <div className="text-sm text-green-700">lbs CO₂ absorbed annually</div>
                      </div>
                      <div className="bg-blue-50 rounded-xl p-4 text-center">
                        <div className="text-2xl font-bold text-blue-600">{impact.marineLife}</div>
              ...
              <div className="bg-gradient-to-br from-forest-primary/5 to-ocean-primary/5 rounded-2xl p-6 border">
                <h4 className="font-semibold text-gray-900 mb-4">How Your Donation Helps</h4>
                <div className="space-y-3 text-sm text-gray-600">
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-forest-primary rounded-full mt-2 flex-shrink-0"></div>
                    <p>
          ...
          <div className="mt-12 text-center">
            <h4 className="text-lg font-semibold text-gray-900 mb-4">Share the Green Earth Initiative</h4>
            <p className="text-gray-600 mb-6">Help us reach more environmental champions</p>
            <div className="flex justify-center gap-4">
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors">
                Share on Twitter
              </button>
              <button className="bg-blue-800 hover:bg-blue-900 text-white px-6 py-3 rounded-xl font-semibold transition-colors">
                Share on Facebook
              </button>
